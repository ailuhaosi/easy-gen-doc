import{_ as o}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,m as i,r as a}from"./app.d4d783c9.js";const l={__name:"BizCodeWithFolding",props:{type:{type:String,required:!0}},setup(e){const t={AtomicCompTemplateVue:{desc:"\u539F\u5B50\u7EC4\u4EF6\u6A21\u677FVue\u4EE3\u7801",language:"vue",code:`
    <template>
    ...
    `}};return(p,d)=>{const n=a("CodeWithFolding");return s(),i(n,{key:e.type,desc:t[e.type].desc,language:t[e.type].language,code:t[e.type].code},null,8,["desc","language","code"])}}},c=o(l,[["__file","BizCodeWithFolding.vue"]]);export{c as default};
