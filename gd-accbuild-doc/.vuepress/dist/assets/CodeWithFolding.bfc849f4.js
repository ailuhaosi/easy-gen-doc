import{_ as W}from"./_plugin-vue_export-helper.cdc0426e.js";import{m as _,g as l,h as b,n as m,o as c,c as v,e as t,a as o,t as u,i as E,y as f,r as C,z as F}from"./app.0a958f2e.js";const S={class:"component-wrapper"},A={class:"component-wrapper-demo"},D={class:"code-content",style:{height:"0"}},I={class:"code-content-height"},N={class:"vue"},x={class:"lock-code-word"},M={name:"CodeWithFolding"},j=Object.assign(M,{props:{desc:{type:String,default:"\u8BE6\u7EC6\u63CF\u8FF0"},code:{type:String,default:"",required:!0},language:{type:[String,void 0],default:void 0}},setup(a){const h=a,y=e=>e.split(`
`).length;_(()=>10*y(h.code)),_(()=>({mode:h.language,theme:"default",lineNumbers:!0,smartIndent:!0,indentUnit:2,foldGutter:!0,lineWrapping:!0,gutters:["CodeMirror-linenumbers","CodeMirror-foldgutter","CodeMirror-lint-markers"],matchBrackets:!0,styleActiveLine:!0,readOnly:!0}));const i=l([]),g=l([]),n=l([]),k=e=>{n.value[e]=!n.value[e],m(()=>{n.value[e]===!0?i.value[e].style.height=+g.value[e]+25+"px":i.value[e].style.height=0})},p=l(null),w=()=>{const e=p.value,s=e.getElementsByClassName("code-content-height");i.value=e.getElementsByClassName("code-content");const d=s.length;for(let r=0;r<d;r++)g.value.push(s[r].getBoundingClientRect().height),n.value.push(!1)};return b(()=>{m(()=>{w()})}),(e,s)=>{const d=C("ElIconArrowDownBold"),r=C("ElIconArrowUpBold"),B=F("highlight");return c(),v("div",{class:"demo",ref_key:"CodeWithFoldingContainerRef",ref:p},[t(` <h2>\u521B\u5EFA\u7EC4\u4EF6\u6587\u6863\u6A21\u677F</h2>\r
    <p>\u7EC4\u4EF6\u63CF\u8FF0</p>\r
    <h3>\u7EC4\u4EF6\u529F\u80FD\u540D\u5B57</h3>\r
    <p>\u7EC4\u4EF6\u529F\u80FD\u63CF\u8FF0</p> `),o("div",S,[o("div",A,u(a.desc),1),E((c(),v("div",D,[o("div",I,[t(` <div class="code-user-desc">\r
              \u7EC4\u4EF6\u63CF\u8FF0\u8BF4\u660E\r
